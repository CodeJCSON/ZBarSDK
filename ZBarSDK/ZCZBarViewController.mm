...
-(void)createView{
    ...
    UIImage*image= [UIImage imageNamed:@"qrcode_scan_bg_Green_iphone5@2x.png"];
    ...
    UITextField * textField = [[UITextField alloc] initWithFrame:CGRectMake(50, 350, 200, 50)];
    textField.placeholder = @"      请输入条形码";
    [textField setValue:[UIColor grayColor] forKeyPath:@"_placeholderLabel.textColor"];
    [textField setValue:[UIFont boldSystemFontOfSize:16] forKeyPath:@"_placeholderLabel.font"];
    textField.textColor = [UIColor whiteColor];
    textField.background = [UIImage imageNamed:@"e_03"];
    textField.delegate = self;
    [bgImageView addSubview:textField];
    
    UIButton * btn = [[UIButton alloc] initWithFrame:CGRectMake(270, 350, 50, 50)];
//    btn.imageView.image = [UIImage imageNamed:@"e_05"];
    [btn setImage:[UIImage imageNamed:@"e_05"] forState:UIControlStateNormal];
    ...
    [button setFrame:CGRectMake(20,30, 20, 20)];
    [button addTarget:self action:@selector(pressCancelButton:) forControlEvents:UIControlEventTouchUpInside];
    [self.view addSubview:button];
    
    UILabel *buttonFirst = [[UILabel alloc]initWithFrame:CGRectMake(33, 30, 48, 48)];
    buttonFirst.text = @"首页";
    buttonFirst.font = [UIFont systemFontOfSize:16.5];
    buttonFirst.textColor = [UIColor whiteColor];
    [buttonFirst sizeToFit];
//    [buttonFirst addTarget:self action:@selector(pressCancelButton:) forControlEvents:UIControlEventTouchUpInside];
...
-(void)animation1
{
    [UIView animateWithDuration:2 animations:^{
        ...
        _line.frame = CGRectMake((WIDTH-220)/2, 70+HEIGHT-380, 220, 2);
